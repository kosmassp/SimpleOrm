...
public sealed class GeneratorTests
{
    ...
    {
        var code = MigrationGenerator.EmitRoot(
            "My.Migrations", 4, ["Table.Widget.V0004_Reshape", "Table.Other.V0004_Reshape"], "sqlite");
        ...
        // The root remembers its dialect (ADR-0017 add.3): amend refuses a switch.
        Assert.True(MigrationGenerator.IsGenerated(code));
        Assert.Equal("sqlite", MigrationGenerator.GeneratedDialectLabel(code));
        Assert.Null(MigrationGenerator.GeneratedDialectLabel("/// <summary>Generated by simpleorm diff (ADR-0017); legacy</summary>"));
        Assert.False(MigrationGenerator.IsGenerated("public sealed class V0004 : MigrationVersion { }"));
    }
}
