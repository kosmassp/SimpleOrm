...
| `targetForeignKeyProperties` exported as C# property names | exported as PascalCase of the PHP property name (`userId` → `UserId`) so the export is byte-identical | interim: the spec should switch this field to columns — flagged in ADR-0026 |
