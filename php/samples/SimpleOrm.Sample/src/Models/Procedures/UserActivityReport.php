...
namespace SimpleOrm\Sample\Models\Procedures;
...
/**
 * Procedure-backed entity (ADR-0008 addenda): self-contained, with name, body
 * SQL, and parameter contract in the attribute. Read-only and keyless. Dormant
 * on SQLite (no stored procedures, `supportsProcedures()` false): creation and
 * invocation arrive with a Level 4 dialect. Not a `BaseModel`: projections
 * carry no audit columns.
 */
